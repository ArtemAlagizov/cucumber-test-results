cucumberDashboardBackendUrl='http://'$CUCUMBER_DASHBOARD_BACKEND_IP_AND_PORT'/health-monitoring-services'

services='
{
   "backendIp":'"\"$DEPLOYED_WR_IP\""',
...
echo $services | curl -0 -v -X POST $cucumberDashboardBackendUrl \
-H "Expect:" \
